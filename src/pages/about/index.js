            ...
            <Row className="aboutContainer">
                <Fade bottom>
                    ...
                    <p className="textPrimary f400 fAbout">
                        ...
                        simple and beautiful interface. I also love the logic
                        and structure of coding and always strive to write
                        efficient and reusable codes in Reactjs and React
                        Native.
                    </p>
                    <p className="textPrimary f400 fAbout">
                        When I am not coding you'll find me in Pjaywalker doing
                        travel videos.
                    </p>
                </Fade>
                <Slide bottom>
